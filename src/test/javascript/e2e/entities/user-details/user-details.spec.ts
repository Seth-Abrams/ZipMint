...
describe('UserDetails e2e test', () => {
    ...
    it('should load UserDetails', async () => {
        ...
        expect(await userDetailsComponentsPage.getTitle()).to.eq('jhipsterSampleApplicationApp.userDetails.home.title');
    });
    ...
    it('should load create UserDetails page', async () => {
        ...
        expect(await userDetailsUpdatePage.getPageTitle()).to.eq('jhipsterSampleApplicationApp.userDetails.home.createOrEditLabel');
    ...
    it('should delete last UserDetails', async () => {
        ...
        expect(await userDetailsDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApplicationApp.userDetails.delete.question');
