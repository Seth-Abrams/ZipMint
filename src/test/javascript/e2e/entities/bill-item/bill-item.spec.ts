...
describe('BillItem e2e test', () => {
    ...
    it('should load BillItems', async () => {
        ...
        expect(await billItemComponentsPage.getTitle()).to.eq('jhipsterSampleApplicationApp.billItem.home.title');
    });
    ...
    it('should load create BillItem page', async () => {
        ...
        expect(await billItemUpdatePage.getPageTitle()).to.eq('jhipsterSampleApplicationApp.billItem.home.createOrEditLabel');
    ...
    it('should delete last BillItem', async () => {
        ...
        expect(await billItemDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApplicationApp.billItem.delete.question');
