...
describe('Budget e2e test', () => {
    ...
    it('should load Budgets', async () => {
        ...
        expect(await budgetComponentsPage.getTitle()).to.eq('jhipsterSampleApplicationApp.budget.home.title');
    });
    ...
    it('should load create Budget page', async () => {
        ...
        expect(await budgetUpdatePage.getPageTitle()).to.eq('jhipsterSampleApplicationApp.budget.home.createOrEditLabel');
    ...
    it('should delete last Budget', async () => {
        ...
        expect(await budgetDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApplicationApp.budget.delete.question');
