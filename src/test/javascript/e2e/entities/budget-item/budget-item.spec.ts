...
describe('BudgetItem e2e test', () => {
    ...
    it('should load BudgetItems', async () => {
        ...
        expect(await budgetItemComponentsPage.getTitle()).to.eq('jhipsterSampleApplicationApp.budgetItem.home.title');
    });
    ...
    it('should load create BudgetItem page', async () => {
        ...
        expect(await budgetItemUpdatePage.getPageTitle()).to.eq('jhipsterSampleApplicationApp.budgetItem.home.createOrEditLabel');
    ...
    it('should delete last BudgetItem', async () => {
        ...
        expect(await budgetItemDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApplicationApp.budgetItem.delete.question');
