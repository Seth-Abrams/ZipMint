...
describe('Transaction e2e test', () => {
    ...
    it('should load Transactions', async () => {
        ...
        expect(await transactionComponentsPage.getTitle()).to.eq('jhipsterSampleApplicationApp.transaction.home.title');
    });
    ...
    it('should load create Transaction page', async () => {
        ...
        expect(await transactionUpdatePage.getPageTitle()).to.eq('jhipsterSampleApplicationApp.transaction.home.createOrEditLabel');
    ...
    it('should delete last Transaction', async () => {
        ...
        expect(await transactionDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApplicationApp.transaction.delete.question');
