...
describe('Bills e2e test', () => {
    ...
    it('should load Bills', async () => {
        ...
        expect(await billsComponentsPage.getTitle()).to.eq('jhipsterSampleApplicationApp.bills.home.title');
    });

    it('should load create Bills page', async () => {
        await billsComponentsPage.clickOnCreateButton();
        billsUpdatePage = new BillsUpdatePage();
        expect(await billsUpdatePage.getPageTitle()).to.eq('jhipsterSampleApplicationApp.bills.home.createOrEditLabel');
    ...
    it('should delete last Bills', async () => {
        ...
        expect(await billsDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApplicationApp.bills.delete.question');
