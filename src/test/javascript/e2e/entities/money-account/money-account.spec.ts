...
describe('MoneyAccount e2e test', () => {
    ...
    it('should load MoneyAccounts', async () => {
        ...
        expect(await moneyAccountComponentsPage.getTitle()).to.eq('jhipsterSampleApplicationApp.moneyAccount.home.title');
    });
    ...
    it('should load create MoneyAccount page', async () => {
        ...
        expect(await moneyAccountUpdatePage.getPageTitle()).to.eq('jhipsterSampleApplicationApp.moneyAccount.home.createOrEditLabel');
    ...
    it('should delete last MoneyAccount', async () => {
        ...
        expect(await moneyAccountDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApplicationApp.moneyAccount.delete.question');
